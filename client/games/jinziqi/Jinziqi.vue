...
import { JinziqiEvent, JinziqiGameInfo, Piece } from 'shared/games/jinziqi';
import { computed } from 'vue';
import Board from './Board.vue';

const { gameInfo, send, joiner } = useGame<JinziqiEvent, JinziqiGameInfo>()
const opponent = computed(() => useSocketStore().state.roomInfo?.joiners.find((j) => j.uuid !== joiner.value.uuid)!)
